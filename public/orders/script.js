...
function updateView(orders, usingSocket) {
    ...
    if (usingSocket) {
        ...
        header.innerHTML = `<div id="hd-container" style="display:flex; align-items:center"><h2 class="display-5"style="padding-right:5%">Orders</h2><span class="spinner-border spinner-border-sm text-secondary" style="" role="status" aria-hidden="true"><span class="sr-only">Loading...</span></span></div>`
...
function updateNOrders(htmlObj, n) {
    htmlObj.innerHTML = `<div id="hd-container"><h2 class="display-5">Orders (${n})</h1></div>`
}
